...
//     try {
//       const response = await fetchApi("admin_get_repairs");
//       if (response.success) {
...
//     try {
//       await fetchApi("admin_update_repair", {
//         method: "POST",
//         body: JSON.stringify({
...
//         await fetchApi("admin_send_notification", {
//           method: "POST",
//           body: JSON.stringify({
//             user_id: null, // Since repairs don't have user_id, we'll send general notification
//             type: "repair",
//             title: `Repair Status Update - ${selectedRepair.marque} ${selectedRepair.modele}`,
...
//     (repair) => filter === "all" || repair.statut === filter
//   );

//   if (loading) {
//     return <div className="loading">Loading repair requests...</div>;
//   }
...
//             Pending: {repairs.filter((r) => r.statut === "en_attente").length}
//           </span>
//           <span className="stat-badge progress">
//             In Progress: {repairs.filter((r) => r.statut === "en_cours").length}
//           </span>
//           <span className="stat-badge completed">
//             Completed: {repairs.filter((r) => r.statut === "termine").length}
//           </span>
//         </div>
//       </div>
...
//             <div className="repair-header-card">
//               <div className="repair-id">#{repair.id}</div>
//               <div className={`status-badge ${getStatusColor(repair.statut)}`}>
...
//                 <p>
//                   <strong>Customer:</strong> {repair.nom}
//                 </p>
//                 <p>
//                   <strong>Email:</strong> {repair.email}
//                 </p>
//                 <p>
...
//                 <p>
//                   <strong>Quote Requested:</strong>{" "}
//                   {repair.devis_demande ? "Yes" : "No"}
//                 </p>
//                 <p>
...
//           <p>No repair requests found for the selected filter.</p>
//         </div>
//       )}
...
//                 <h4>
//                   {selectedRepair.marque} {selectedRepair.modele}
//                 </h4>
//                 <p>Customer: {selectedRepair.nom}</p>
//               </div>
...
//                   placeholder="Enter a message to notify the customer about this update..."
//                   rows="3"
