    ...
    try {
      ...
      const response = await fetch('/Backend/admin_routes.php?action=admin_update_password', {
        ...
        body: JSON.stringify({
             ...
             currentPassword: passwordForm.currentPassword,   // ✅ camelCase
             newPassword: passwordForm.newPassword,           // ✅ camelCase
             confirmPassword: passwordForm.confirmPassword    // ✅ camelCase
        })
      });
